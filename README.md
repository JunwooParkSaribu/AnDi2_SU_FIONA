...
> [!NOTE]
> ___ takes around 1hr for the inference of 1,000 trajectories with default settings on a single L4 / RTX3090 chip. We don't recommend to the inference on large datasets without GPU.</br>
